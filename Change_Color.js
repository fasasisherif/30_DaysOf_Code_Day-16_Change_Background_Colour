...
circle.style.backgroundColor = hexacode;	
...
//HERE WE CREATE AN ANIMATION WITH JAVASCRIPT

/* THE NAME OF THE ANIMATION IS 'expand' AND WE STYLE IT USING CSS */

function myfunc3(){
document.getElementById('circle').className = 'expand';
}


button[0].addEventListener("click",myfunc3);
